...
public class RetAppUtil {
	 ...
	 * @return
	 */
	public static RetApp success(Object object,String message,Long totall){
		RetApp retApp=new RetApp();
		retApp.setTotall(totall);
	 ...
	 * @return
	 */
	public static RetApp tokenDisabled(){
		RetApp retApp=new RetApp();
		retApp.setStatus(RestApiExceptionEnums.UNLOGIN_EXCEPTION.getCode().toString());
		retApp.setData(null);
		retApp.setMessage(RestApiExceptionEnums.UNLOGIN_EXCEPTION.getMessage());
		return retApp;
	}
}

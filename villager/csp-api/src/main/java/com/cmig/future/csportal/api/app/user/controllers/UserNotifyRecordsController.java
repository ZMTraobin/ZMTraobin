 ...
 */
@Controller//userPath
@RequestMapping(value = "${userPath}/st/notifyRecords/")
@ResponseBody
public class UserNotifyRecordsController extends BaseExtendController {

    private static Logger logger = LoggerFactory.getLogger(UserNotifyRecordsController.class);
    ...
    public RetApp list(HttpServletRequest request, HttpServletResponse response,@RequestParam(defaultValue = DEFAULT_PAGE) int page,
        ...
        try {
            ...
            sysNotifyRecord.setAppUserId(userId);
            ...
            //jsonObject.put("notifyList",list);
    ...
    @RequestMapping(value = "getNoReadCount", produces = { "application/json" }, method = RequestMethod.POST)
    public RetApp getNoReadCount(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            sysNotifyRecord.setReadFlag(Constants.NO);
            List<SysNotifyRecord> list_NORead = sysNotifyRecordService.selectSysNotifyRecord(sysNotifyRecord);
            jsonObject.put("noReadCount",list_NORead!=null?list_NORead.size():"0");

...
import com.cmig.future.csportal.storm.bolt.AcsNumCounter;
import com.cmig.future.csportal.storm.bolt.AcsNumSplitter;
...
public class AcsNumTopology {
	...
	public static void main(String[] args) throws AlreadyAliveException, InvalidTopologyException, InterruptedException {
		...
		builder.setBolt("num-splitter", new AcsNumSplitter(), 2).shuffleGrouping("kafka-reader");
		builder.setBolt("num-counter", new AcsNumCounter()).fieldsGrouping("num-splitter", new Fields("time"));

		Config conf = new Config();

		String name = AcsNumTopology.class.getSimpleName();

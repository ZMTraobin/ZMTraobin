package com.cmig.future.csportal.module.pay.pingxx.example;
...
public class Main {
     ...
     */
    private final static String apiKey = "sk_test_OaLCGSXPGu9Sn94K88inP48O";

    /**
     * Pingpp 管理平台对应的应用 ID，app_id 获取方式：登录 [Dashboard](https://dashboard.pingxx.com)->点击你创建的应用->应用首页->应用 ID(App ID)
     */
    private final static String appId = "app_O0mTiDWrjj50enbr";
   ...
   */
    ...
    // 你生成的私钥路径
    private final static String privateKeyFilePath = "res/csp_rsa_private_key.pem";

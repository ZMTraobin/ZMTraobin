...
import com.cmig.future.csportal.common.utils.CookieUtils;
...
public class Page<T> implements Serializable{
	...
	*/
	...
	private int pageSize = Integer.valueOf(Global.getConfig("neighbourhood.page.pageSize")); // 页面大小，设置为“-1”表示不进行分页（分页无效）
